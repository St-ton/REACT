...
//todo 15) создать функцию, которая по кругу выводит строки из массива words при каждом вызове одно слово
//* const words = ['велосипед', 'самокат', 'стул', 'дверь'];
//* let wordsIndex = 0;
//* function show() {
//*   console.log(words[wordsIndex]);
//*   wordsIndex === words.length - 1 ? 0 : wordsIndex + 1;
//* }
//* show();

// todo 16) написать цикл, который выводит слова поряд по кругу
// * для реализации данного процесса нельзя использовать дополнительные переменные
//*for (let i = 0; i < 50; i++) {
